...
const banner2 = cfonts.render(('by:Sr.Collins..grupo oficial do bot 👉 https://chat.whatsapp.com/BATZexgmg0z9TGMURrBzB5'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`SUKUNA MD 2.3`), {
font: 'tiny',             
align: 'center',           
